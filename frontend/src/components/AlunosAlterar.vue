  ...
  <div class="columns">
    <div class="column is-two-fifths">
      <form @submit.prevent="onSubmit">
        ...
        <hr />
        <div class="field is-grouped" >
          <button class="button is-success" @click="alterarAlunos(id)">Salvar</button>
...
export default {
  ...
  async created(){
      ...
      const responseA = await Backend.get(`/alunos/${this.$route.params.id}`);
      this.id = responseA.data.data.id;
      this.nome = responseA.data.data.nome;
      this.data_nascimento = responseA.data.data.data_nascimento;
      this.logradouro = responseA.data.data.logradouro;
      this.numero = responseA.data.data.numero;
      this.bairro = responseA.data.data.bairro;
      this.cidade = responseA.data.data.cidade;
      this.estado = responseA.data.data.estado;
      this.cep = responseA.data.data.cep;
      this.item = responseA.data.data.curso.id;
  },
  methods:{
     onSubmit(){
         this.alterarAlunos();
     ...
     ,
      async alterarAlunos(id){
          ...
          await Backend.put(`/alunos/${id}`, data).
                then(response => {
                    (this.nome = ""),
